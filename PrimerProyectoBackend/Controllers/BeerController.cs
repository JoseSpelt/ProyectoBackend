...
namespace PrimerProyectoBackend.Controllers
{
    ...
    public class BeerController : ControllerBase
    {
        ...
        public BeerController(IValidator<BeerInsertDto> beerInsertValidator, IValidator<BeerUpdateDto> beerUpdateValidator, [FromKeyedServices("beerService")] ICommomService<BeerDto, BeerInsertDto, BeerUpdateDto> beerService) 
        { 
